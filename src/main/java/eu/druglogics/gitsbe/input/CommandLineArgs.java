...
public class CommandLineArgs {
    ...
    @Parameter(names = { "--project", "-p" }, required = true, description = "Name of the project", order = 0)
    private String projectName;

    @Parameter(names = { "--network", "-n" }, required = true, description = "Network file", order = 1)
    private String filenameNetwork;

    @Parameter(names = { "--trainingdata", "-t" }, required = true, description = "Training data file", order = 2)
    private String filenameTrainingData;

    @Parameter(names = { "--config", "-c" }, required = true, description = "Configuration file", order = 3)
    private String filenameConfig;

    @Parameter(names = { "--modeloutputs", "-m" }, required = true, description = "Model outputs file", order = 4)
